...
<div class="tabs">
	<ul>
		<li><a href="#tabs-1">Home &raquo; Master Barang &raquo; Edit</a></li>
	</ul>
	<div id="tabs-1">
		<form:form commandName="barang" action="${path}/master/barang/save" method="POST" accept-charset="utf-8">
		...
		<spring:hasBindErrors name="barang">
			<div id="messageBox">
		...
		<p>
			...
			<button onclick="window.location='${path}/master/barang/insert'; return false;">Baru</button>
		</p>
		</form:form>
		<button onclick="window.location='${path}/master/barang'; return false;">&laquo; Kembali</button>
	</div>
</div>
