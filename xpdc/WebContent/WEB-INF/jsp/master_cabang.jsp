...
<div class="tabs">
	<ul>
		<li><a href="#tabs-1">Home &raquo; Master Cabang &raquo; Edit</a></li>
	</ul>
	<div id="tabs-1">
		<form:form commandName="cabang" action="${path}/master/cabang/save" method="POST" accept-charset="utf-8">
		...
		<spring:hasBindErrors name="cabang">
			<div id="messageBox">
		...
		<p>
			...
			<button onclick="window.location='${path}/master/cabang/insert'; return false;">Baru</button>
		</p>
		</form:form>
		<button onclick="window.location='${path}/master/cabang'; return false;">&laquo; Kembali</button>
	</div>
</div>
